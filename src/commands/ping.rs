...
impl CommandTrait for PingCommand {
    ...
    fn run(_options: &[CommandDataOption], response: &mut CreateInteractionResponse) {
        response
            .kind(InteractionResponseType::ChannelMessageWithSource)
            .interaction_response_data(|message| message
                .embed(|e| {
                    let start = Bot::start_timestamp().unix_timestamp();
                    ...
                    e
                        ...
                        .field("Online sejak", time_format::timestamp_to_string(&Bot::start_timestamp()), true)
